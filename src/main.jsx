...
import { faMoon, faSun, faHouse, faDiagramProject, faHeart, faCircleArrowDown, faCopy, faSignature, faEnvelope, faBars } from '@fortawesome/free-solid-svg-icons';
...
library.add(
  ...
  faDiagramProject, faHeart, faCircleArrowDown, faCopy, faSignature, faEnvelope, faEnvelope, faBars
);
